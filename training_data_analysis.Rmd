...
```{r, install_packages}
# install packages
utils::install.packages("https://cran.r-project.org/src/contrib/Archive/googlesheets4/googlesheets4_1.0.1.tar.gz",
                        repos = NULL,
                        type = "source")
utils::install.packages("https://cran.r-project.org/src/contrib/Archive/dplyr/dplyr_1.1.1.tar.gz",
                        repos = NULL,
                        type = "source")
utils::install.packages("https://cran.r-project.org/src/contrib/Archive/tidyr/tidyr_1.2.1.tar.gz",
                        repos = NULL,
                        type = "source")
utils::install.packages("https://cran.r-project.org/src/contrib/Archive/plotly/plotly_4.10.1.tar.gz",
                        repos = NULL,
                        type = "source")
utils::install.packages("https://cran.r-project.org/src/contrib/Archive/janitor/janitor_2.1.0.tar.gz",
                        repos = NULL,
                        type = "source")
utils::install.packages("https://cran.r-project.org/src/contrib/Archive/DT/DT_0.27.tar.gz",
                        repos = NULL,
                        type = "source")
utils::install.packages("https://cran.r-project.org/src/contrib/Archive/gtools/gtools_3.9.3.tar.gz",
                        repos = NULL,
                        type = "source")
utils::install.packages("https://cran.r-project.org/src/contrib/Archive/yaml/yaml_2.3.6.tar.gz",
                        repos = NULL,
                        type = "source")
```
