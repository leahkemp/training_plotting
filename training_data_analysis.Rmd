...
package_list <- list("https://cran.r-project.org/src/contrib/Archive/crosstalk/crosstalk_1.1.1.tar.gz",
                     "https://cran.r-project.org/src/contrib/Archive/snakecase/snakecase_0.10.0.tar.gz",
                     "https://cran.r-project.org/src/contrib/Archive/googlesheets4/googlesheets4_1.0.1.tar.gz",
                     "https://cran.r-project.org/src/contrib/Archive/dplyr/dplyr_1.1.1.tar.gz",
                     "https://cran.r-project.org/src/contrib/Archive/tidyr/tidyr_1.2.1.tar.gz",
                     "https://cran.r-project.org/src/contrib/Archive/plotly/plotly_4.10.1.tar.gz",
                     "https://cran.r-project.org/src/contrib/Archive/janitor/janitor_2.1.0.tar.gz",
                     "https://cran.r-project.org/src/contrib/Archive/DT/DT_0.27.tar.gz",
                     "https://cran.r-project.org/src/contrib/Archive/gtools/gtools_3.9.3.tar.gz",
                     "https://cran.r-project.org/src/contrib/Archive/yaml/yaml_2.3.6.tar.gz",
                     "https://cran.r-project.org/src/contrib/Archive/crosstalk/crosstalk_1.1.1.tar.gz")
...
## CURRENTLY WORKS FOR 3 SPREADSHEETS DEFINED IN CONFIG FILE - need to make it dynamically grab the spreadsheets
```

```{r, prepare_data}
# create a list of the datasets I'm working with
dataset_list <- base::c(read_data_1, read_data_2, read_data_3)
